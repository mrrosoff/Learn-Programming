...
Welcome to your first C++ program! The main goal of this test is to get you familiar with the developer tools (Visual Studio Code, Terminal, etc) as well as to code, compile, and execute your first program. Let's go ahead and break down the structure of [this](./main.cpp) program.
